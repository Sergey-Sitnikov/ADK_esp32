...
extern "C" void app_main()
{
  ...
  xTaskCreatePinnedToCore(Traffic_lights, "Traffic_lights", 1024 * 4, NULL, 1, NULL, 1);
  // xTaskCreate(Traffic_lights, "Traffic_lights", 1024 * 4, NULL, 1, NULL);
  //    xTaskCreate(web, "Web", 1024 * 2, NULL, 3, NULL);
  xTaskCreatePinnedToCore(Button_pedastrian, "Button_pedastrian", 1024, NULL, 1, NULL, 0);
  xTaskCreatePinnedToCore(uart_task, "uart_task", 1024 * 2, NULL, 5, NULL, 0);
}